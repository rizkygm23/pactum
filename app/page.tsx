...
export default async function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <main>
        {/* ── Masthead · full-bleed scrim stage ─────────────────── */}
        <section className="bg-scrim">
          <div className="grid grid-cols-1 lg:grid-cols-[2.5rem_minmax(0,38rem)_minmax(0,1fr)] gap-0">
            ...
            <div className="px-5 pb-12 pt-16 sm:px-8 sm:pb-16 sm:pt-20 lg:px-0 lg:pb-20 lg:pt-24">
              <p className="eyebrow text-on-primary/70">Metered billing on arc</p>
              <h1 className="display-face mt-6 text-[2.75rem] font-normal leading-[1.02] text-on-primary sm:text-[3.25rem]">
                Bill per token.
                <br />
                Settle in USDC.
              </h1>

              <p className="mt-7 max-w-[38rem] text-base leading-relaxed text-on-primary/70 sm:text-lg">
              ...
              <div className="mt-9 flex flex-wrap items-center gap-x-6 gap-y-4">
                <Link
                  href="/signup"
                  className="btn-inverse focus-ring no-wrap"
                >
                  Get an API key
                </Link>
                <a
                  ...
                  className="focus-ring no-wrap text-sm font-semibold text-on-primary underline-offset-4 hover:underline"
                >
                  Try Live Demo
                </a>
                <Link
                  href="/docs"
                  className="focus-ring no-wrap text-sm font-semibold text-on-primary/70 underline-offset-4 transition-colors hover:text-on-primary hover:underline"
                >
                  Read Documentation
                </Link>
              </div>

              <p className="data-mono mt-10 text-xs text-on-primary/50">
                Arc Testnet · chain {ARC_TESTNET.chainId}
              </p>
            </div>

            {/* Receipt stub — white card breaks against the scrim */}
        ...
        {/* ── Stage 1.0 · Fund ──────────────────────────────────── */}
        <RevealOnView as="section" className="border-b border-hairline bg-canvas">
          <div className="grid grid-cols-1 lg:grid-cols-[2.5rem_minmax(0,38rem)_minmax(0,1fr)] gap-0">
            ...
            <div className="px-5 pb-12 pt-5 sm:px-8 sm:pb-16 sm:pt-8 lg:px-0 lg:pb-20 lg:pt-20">
              <h2 className="display-face text-3xl font-normal tracking-[-0.02em] text-ink sm:text-4xl">
                The balance exists before the first call
              </h2>

              <p className="mt-7 max-w-2xl text-base leading-relaxed text-graphite">
              ...
              <ul className="mt-10 max-w-2xl border-t border-hairline">
                <li className="ledger-tick ledger-row flex items-baseline justify-between gap-4">
                  <span className="text-sm text-ink">Deposit</span>
                  <span className="data-mono text-xs text-slate">
                    USDC → PactumBilling
                  </span>
                </li>
                <li className="ledger-tick ledger-row flex items-baseline justify-between gap-4">
                  <span className="text-sm text-ink">Balance read</span>
                  <span className="data-mono text-xs text-slate">
                    userBalances(address)
                  </span>
                </li>
                <li className="ledger-tick ledger-row flex items-baseline justify-between gap-4">
                  <span className="text-sm text-ink">Withdrawable</span>
                  <span className="data-mono text-xs text-slate">
                    unspent, at any time
                  </span>
                </li>
        ...
        {/* ── Stage 2.0 · Meter ─────────────────────────────────── */}
        <RevealOnView as="section" className="border-b border-hairline bg-canvas-warm">
          <div className="grid grid-cols-1 lg:grid-cols-[2.5rem_minmax(0,28rem)_minmax(0,1fr)] xl:grid-cols-[2.5rem_minmax(0,32rem)_minmax(0,1fr)] gap-0">
            ...
            <div className="px-5 pb-12 pt-5 sm:px-8 sm:pb-16 sm:pt-8 lg:px-0 lg:pb-20 lg:pt-20">
              ...
              <p className="mt-7 text-base leading-relaxed text-graphite">
                ...
                <span className="data-mono text-ink">idempotency_key</span>{" "}
                twice — from a retry, a queue redelivery, a nervous client — and
                the second one comes back{" "}
                <span className="data-mono text-ink">deduplicated</span>,
                not double-charged.
              </p>

              <p className="mt-6 text-base leading-relaxed text-graphite">
                When the balance will not cover the call, the answer is{" "}
                <span className="data-mono font-semibold text-ink">402</span>. Your
                service decides what to do with that; Pactum simply refuses to
                record a charge that cannot be settled.
              </p>
            </div>
...
→ 200  { "recorded": true,
        ...
        <RevealOnView as="section" className="border-b border-hairline bg-canvas">
          <div className="grid grid-cols-1 lg:grid-cols-[2.5rem_minmax(0,1fr)_18rem] xl:grid-cols-[2.5rem_minmax(0,1fr)_22rem] gap-0">
            ...
            <div className="px-5 pb-12 pt-5 sm:px-8 sm:pb-16 sm:pt-8 lg:px-0 lg:pb-20 lg:pr-16 lg:pt-20">
              <h2 className="display-face max-w-3xl text-3xl font-normal tracking-[-0.02em] text-ink sm:text-4xl">
            ...
            <div className="flex items-start justify-center px-5 pb-12 sm:px-8 sm:pb-16 lg:justify-end lg:px-0 lg:py-20 lg:pr-8 xl:pr-12">
              <div className="flex flex-col items-center gap-5 lg:sticky lg:top-8">
                ...
                <p className="data-mono text-center text-xs leading-relaxed text-stone">
                  Specimen seal.
                  <br />
                  Real ones link to
                  <br />
              ...
              <dl className="grid grid-cols-1 gap-x-8 gap-y-1 sm:grid-cols-2 lg:grid-cols-3">
                {NETWORK_FACTS.map((fact) => (
                  <div key={fact.term} className="spec-row border-b-0 py-4">
                    <dt className="micro-caps text-stone">
                      {fact.term}
                    </dt>
                    <dd>
                      <span className="data-mono block text-sm text-ink break-all">
                        {fact.value}
                      </span>
                      {fact.note && (
                        <span className="mt-1.5 block text-xs leading-relaxed text-slate break-all">
                          {fact.note}
                        </span>
                      )}
                    </dd>
        ...
        {/* ── Closing statement · scrim band ────────────────────── */}
        <section className="bg-scrim">
          <div className="px-5 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-32 xl:px-20">
            <div className="max-w-5xl">
              <p className="display-face text-3xl font-normal leading-[1.1] tracking-[-0.02em] text-on-primary sm:text-4xl lg:text-5xl">
                A bill your customer can verify without asking you.
              </p>

              <div className="rule-mark mt-10 max-w-40 bg-on-primary" />
              ...
              <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="focus-ring no-wrap text-sm font-semibold text-on-primary/80 underline-offset-4 transition-colors hover:text-on-primary hover:underline"
                >
                  Try Live Demo
                </a>
                <Link
        ...
        {/* ── Footer · near-black terminal surface ──────────────── */}
        <footer className="bg-footer">
          <div className="flex flex-wrap items-center justify-between gap-4 px-5 py-6 sm:px-8 lg:px-12 xl:px-20">
            <span className="text-sm font-semibold text-on-primary no-wrap">
              pactum
            </span>
            <span className="data-mono text-xs text-stone">
